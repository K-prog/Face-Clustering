...
- face_distance_tolerance (default 0.18)  *Tolerance value used to compare two faces*
- min_faces_cluster (default 10),  *Minimum faces to form cluster*
- percentage_for_non_identified (default 0.3)  *Percentage value for comparing non identified faces to already made clusters*
